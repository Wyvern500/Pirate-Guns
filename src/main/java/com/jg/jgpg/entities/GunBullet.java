...
public class GunBullet extends ThrowableProjectile implements ItemSupplier {
    ...
    public GunBullet setDamage(float damage) {
        ...
        LogUtils.getLogger().info("EntityData Dmg: " + entityData.get(GunBullet.DAMAGE));
        return this;
    }
        ...
        if (result.getType() == Type.ENTITY) {
            ...
            if (!this.level().isClientSide) {
                if (hit.getEntity() instanceof LivingEntity && this.shooter != null) {
                    ...
                    DamageSource src = level().damageSources().mobAttack(this.shooter);
					...
					/*OldGuns.channel.sendTo(new StartHitmarkerMessage(), ((ServerPlayer) shooter).connection.connection,
    ...
    public ItemStack getItem() {
        return new ItemStack(ItemRegistries.MUSKET_BULLET.get());
    }
