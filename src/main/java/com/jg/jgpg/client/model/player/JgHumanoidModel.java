...
@OnlyIn(Dist.CLIENT)
public class JgHumanoidModel<T extends LivingEntity> extends AgeableListModel<T> implements ArmedModel, HeadedModel {
   ...
   public JgHumanoidModel.ArmPose leftArmPose = JgHumanoidModel.ArmPose.EMPTY;
   public JgHumanoidModel.ArmPose rightArmPose = JgHumanoidModel.ArmPose.EMPTY;
   public List<ModelPart> parts;
   public boolean crouching;
   public float swimAmount;
   protected ClientHandler client;

   public JgHumanoidModel(ModelPart p_170677_, ClientHandler client) {
      this(p_170677_, RenderType::entityCutoutNoCull, client);
   }

   public JgHumanoidModel(ModelPart p_170679_, Function<ResourceLocation, RenderType> p_170680_, 
   ...
   public void setupAnim(T p_102866_, float p_102867_, float p_102868_, float p_102869_, float p_102870_, float p_102871_) {
      ...
      if (this.rightArmPose != JgHumanoidModel.ArmPose.SPYGLASS) {
         AnimationUtils.bobModelPart(this.rightArm, p_102869_, 1.0F);
      }

      if (this.leftArmPose != JgHumanoidModel.ArmPose.SPYGLASS) {
   ...
   private void poseRightArm(T p_102876_) {
      switch (this.rightArmPose) {
         ...
         case SPYGLASS:
        	...
        	// Al modificar esto da un error de hotcode replace, solucionalo Ivan del futuro
            this.rightArm.xRot = Mth.clamp(this.head.xRot - 1.9198622F, -2.4F, 3.3F);
            this.rightArm.yRot = this.head.yRot - (0.2617994F * 1.5f);
            break;
         case TOOT_HORN:
   ...
   public void copyPropertiesTo(JgHumanoidModel<T> p_102873_) {
   ...
   public static enum ArmPose implements net.minecraftforge.common.IExtensibleEnum {
      ...
      private final JgIArmPoseTransformer forgeArmPose;

      private ArmPose(boolean twoHanded, @javax.annotation.Nonnull JgIArmPoseTransformer forgeArmPose) {
      ...
      public static ArmPose create(String name, boolean twoHanded, @javax.annotation.Nonnull JgIArmPoseTransformer forgeArmPose) {
         throw new IllegalStateException("Enum not extended");
      }

      public <T extends LivingEntity> void applyTransform(JgHumanoidModel<T> model, T entity, net.minecraft.world.entity.HumanoidArm arm) {
