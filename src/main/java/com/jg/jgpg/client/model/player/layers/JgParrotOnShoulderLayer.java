...
@OnlyIn(Dist.CLIENT)
public class JgParrotOnShoulderLayer<T extends Player> extends RenderLayer<T, JgPlayerModel<T>> {
	private final ParrotModel model;

	public JgParrotOnShoulderLayer(RenderLayerParent<T, JgPlayerModel<T>> p_174511_, EntityModelSet p_174512_) {
		super(p_174511_);
		this.model = new ParrotModel(p_174512_.bakeLayer(ModelLayers.PARROT));
	}

	public void render(PoseStack p_117307_, MultiBufferSource p_117308_, int p_117309_, T p_117310_, float p_117311_,
			float p_117312_, float p_117313_, float p_117314_, float p_117315_, float p_117316_) {
	...
	private void render(PoseStack p_117318_, MultiBufferSource p_117319_, int p_117320_, T p_117321_, float p_117322_,
			float p_117323_, float p_117324_, float p_117325_, boolean p_117326_) {
