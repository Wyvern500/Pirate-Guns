...
@OnlyIn(Dist.CLIENT)
public class JgSpinAttackEffectLayer<T extends LivingEntity> extends RenderLayer<T, JgPlayerModel<T>> {
	public static final ResourceLocation TEXTURE = new ResourceLocation("textures/entity/trident_riptide.png");
	public static final String BOX = "box";
	private final ModelPart box;

	public JgSpinAttackEffectLayer(RenderLayerParent<T, JgPlayerModel<T>> p_174540_, EntityModelSet p_174541_) {
		super(p_174540_);
	...
	public void render(PoseStack p_117526_, MultiBufferSource p_117527_, int p_117528_, T p_117529_, float p_117530_,
			float p_117531_, float p_117532_, float p_117533_, float p_117534_, float p_117535_) {
