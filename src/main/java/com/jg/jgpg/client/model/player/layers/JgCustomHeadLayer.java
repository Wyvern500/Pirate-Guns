...
@OnlyIn(Dist.CLIENT)
public class JgCustomHeadLayer<T extends LivingEntity, M extends EntityModel<T> & HeadedModel>
	...
	public JgCustomHeadLayer(RenderLayerParent<T, M> p_174475_, EntityModelSet p_174476_) {
		this(p_174475_, p_174476_, 1.0F, 1.0F, 1.0F);
	}

	public JgCustomHeadLayer(RenderLayerParent<T, M> p_174478_, EntityModelSet p_174479_, float p_174480_,
			float p_174481_, float p_174482_) {
		super(p_174478_);
	...
	public void render(PoseStack p_116731_, MultiBufferSource p_116732_, int p_116733_, T p_116734_, float p_116735_,
			float p_116736_, float p_116737_, float p_116738_, float p_116739_, float p_116740_) {
		...
		if (!itemstack.isEmpty()) {
			...
			if (item instanceof BlockItem && ((BlockItem) item).getBlock() instanceof AbstractSkullBlock) {
				...
				SkullBlockRenderer.renderSkull((Direction) null, 180.0F, p_116735_, p_116731_, p_116732_, p_116733_,
				...
				Minecraft.getInstance().gameRenderer.itemInHandRenderer.renderItem(p_116734_, itemstack,
						ItemDisplayContext.HEAD, false, p_116731_, p_116732_, p_116733_);
			}
