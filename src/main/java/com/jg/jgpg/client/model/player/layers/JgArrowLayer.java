...
@OnlyIn(Dist.CLIENT)
public class JgArrowLayer<T extends LivingEntity, M extends JgPlayerModel<T>> extends JgStuckInBodyLayer<T, M> {

	private final EntityRenderDispatcher dispatcher;

	public JgArrowLayer(EntityRendererProvider.Context p_174465_, LivingEntityRenderer<T, M> p_174466_) {
		super(p_174466_);
	...
	protected void renderStuckItem(PoseStack p_116569_, MultiBufferSource p_116570_, int p_116571_, Entity p_116572_,
			float p_116573_, float p_116574_, float p_116575_, float p_116576_) {
