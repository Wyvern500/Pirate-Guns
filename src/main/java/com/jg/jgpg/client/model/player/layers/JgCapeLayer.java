...
@OnlyIn(Dist.CLIENT)
public class JgCapeLayer extends RenderLayer<AbstractClientPlayer, JgPlayerModel<AbstractClientPlayer>> {
	
	public JgCapeLayer(RenderLayerParent<AbstractClientPlayer, JgPlayerModel<AbstractClientPlayer>> p_116602_) {
		super(p_116602_);
	}
