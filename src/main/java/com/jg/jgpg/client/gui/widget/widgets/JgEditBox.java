...
@OnlyIn(Dist.CLIENT)
public class JgEditBox extends AbstractWidget implements Renderable {
	...
	public void renderWidget(GuiGraphics p_283252_, int p_281594_, int p_282100_, float p_283101_) {
		if (this.isVisible()) {
			if (this.isBordered()) {
				...
				p_283252_.fill(this.getX() - 1, this.getY() - 1, this.getX() + this.width + 1,
						this.getY() + this.height + 1, i);
				p_283252_.fill(this.getX(), this.getY(), this.getX() + this.width, this.getY() + this.height,
						-16777216);
			}
	...
	public boolean isMouseOver(double p_94157_, double p_94158_) {
		return this.visible && p_94157_ >= (double) this.getX() && p_94157_ < (double) (this.getX() + this.width)
				&& p_94158_ >= (double) this.getY() && p_94158_ < (double) (this.getY() + this.height);
	}
	...
	public int getScreenX(int p_94212_) {
		return p_94212_ > this.value.length() ? this.getX()
				: this.getX() + this.font.width(this.value.substring(0, p_94212_));
	}
